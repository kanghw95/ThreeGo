...
<p id="searchresult">
	...
	<br>
	<form method="post" action="<%=request.getContextPath()%>/adminqnaanswer" style="display: inline-block;">
		<input type="submit"  id="write" value="글쓰기">
		<input type="hidden" value="5" name="a_num">			
		<input type="hidden" value="notify" name="notify">			
	</form>
	<input type="button" class="button" id="backtolist" value="메인화면" onclick="location.href='<%=request.getContextPath()%>/admin/adminmain';">
	<Br>
