   ...
   <form action="<%=request.getContextPath() %>/adminctrl" method="get">
      ...
      <table >
         ...
         <tr>
            ...
            <input type="button" name="${i.user_no }" value="정지풀기" onclick="startmodal('${i.nickname }',${i.user_no });">
            </c:if>
            <c:if test="${i.user_authority ==1}">
            <input type="button" name="${i.user_no }" value="일시정지" onclick="stopmodal('${i.nickname }',${i.user_no });">
            </c:if>
