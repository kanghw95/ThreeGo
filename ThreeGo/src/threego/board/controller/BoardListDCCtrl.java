...
/**
 * Servlet implementation class BoardDClistCtrl
 */
@WebServlet("/boardlist3")
public class BoardListDCCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardListDCCtrl() {
        super();
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("search", search);
		 ...
		 request.getRequestDispatcher("/WEB-INF/main/board_main/DClist.jsp").forward(request, response);
