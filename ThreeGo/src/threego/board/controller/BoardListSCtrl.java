...
/**
 * Servlet implementation class BoardListSCtrl
 */
@WebServlet("/boardlist2")
public class BoardListSCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardListSCtrl() {
        super();
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("search", search);
		   ...
		   request.getRequestDispatcher("/WEB-INF/main/board_main/Slist.jsp").forward(request, response);
