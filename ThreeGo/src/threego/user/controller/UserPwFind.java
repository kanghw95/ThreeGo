 ...
 */
@WebServlet("/userpwfind")
public class UserPwFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		resultVo = new UserService().pwFind(email, name, id);
		String pw =  resultVo.getUser_pwd();
		if (pw != null) {
...
//				String password = "aldcmuqazcdnembk"; // 지메일용
			...
			try {
				...
				msg.setText("비밀번호는 " + pw + "입니다. 노출되지 않도록 주의하세요");
			...
			out.println("<script>alert('입력하신 이메일로 비밀번호가 발송됐습니다.'); location.href='"+ request.getContextPath()+"/main"+"';</script>");
			out.flush();
			out.close();
